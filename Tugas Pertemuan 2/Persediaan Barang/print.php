...
<table style="border: 1px solid gray;" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<th style="border-right: 1px solid gray">Tanggal Barang Masuk</th>
		<th style="border-right: 1px solid gray">Nama Barang</th>
		<th style="border-right: 1px solid gray">Harga</th>
		<th style="border-right: 1px solid gray">Jumlah Masuk</th>
	...
	<tbody>
		...
		if (!empty($result)) {
			...
			<?php endforeach; 
				...
				<tr>
					<td colspan="9">Belum ada data pada tabel persediaan barang</td>
				</tr>
			<?php } ?>
	</tbody>
</table>
